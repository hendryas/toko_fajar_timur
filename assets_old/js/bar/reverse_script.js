$("button[name='btnAktifReverseTambahStokBar']").click(function (e) {
	...
	Swal.fire({
		...
		if (result.isConfirmed) {
			$.ajax({
				url: "reverse/reverse_data_tambah_stok_bar/reverse.php",
				method: "POST",
				data: formData,
				cache: false,
				contentType: false,
...
$("button[name='btnAktifReverseSisaStok']").click(function (e) {
	...
	Swal.fire({
		...
		if (result.isConfirmed) {
			$.ajax({
				url: "reverse/reverse_data_sisa_stok_bar/reverse.php",
				method: "POST",
				data: formData,
				cache: false,
				contentType: false,
